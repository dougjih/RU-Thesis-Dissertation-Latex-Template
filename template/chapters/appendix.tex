...
\Cref{appendix:table:Loci and alleles measured by the GlobalFiler v1 chemistry kit} lists the loci and alleles that are measured by the GlobalFiler v1 chemistry kit, excluding AMEL as it is not in an autosome. The LFTDI uses this kit to collect the EPG data that this thesis uses.
