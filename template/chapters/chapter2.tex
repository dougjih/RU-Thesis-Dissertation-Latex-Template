...
\Cref{table:Excerpt of an EPG data file after preprocessing} shows an excerpt of EPG data after preprocessing. Each row is a distinct sample file, and each column is a distinct tuple of locus, allele, and measurement.
...
\Cref{table:Counts of genotypes by sample type} lists the numbers of genotypes in each of the sample types. \Cref{table:Counts of EPGs by sample type} lists the numbers of EPGs from each of the sample types.
